...
pub struct IncrementalTrainConfig {
    ...
    #[arg(long, help_heading = "Min distance to other Gaussians for a landmark to be added", default_value = "0.01")]
    pub depth_landmark_min_dist: f32,

    #[arg(long, help_heading = "Scale factor multiplied to newly added landmarks", default_value = "1.0")]
